...
-   [Preliminary requirements for data exploration](#preliminary-requirements-for-data-exploration)
    -   [Loading required packages](#loading-required-packages)
    -   [Loading exploration dataset](#loading-exploration-dataset)
-   [Dataset Inspection and QC](#dataset-inspection-and-qc)
    -   [Inspecting the dataset](#inspecting-the-dataset)
    -   [Quality Control](#quality-control)
-   [Data exploration](#data-exploration)
    -   [Distribution of GDP Per Capita across all countries in 2007](#distribution-of-gdp-per-capita-across-all-countries-in-2007)
    -   [Distribution of GDP Per Capita across all countries in 1952](#distribution-of-gdp-per-capita-across-all-countries-in-1952)
    -   [Population distribution across all countries in 2007](#population-distribution-across-all-countries-in-2007)
    -   [Population distribution across all countries in 1952](#population-distribution-across-all-countries-in-1952)
    -   [Sanity check on population across entire dataset](#sanity-check-on-population-across-entire-dataset)
        -   [Identifying outliers](#identifying-outliers)
    -   [Distribution of life expectancy across all countries in 2007](#distribution-of-life-expectancy-across-all-countries-in-2007)
    -   [Distribution of life expectancy across all countries in 1952](#distribution-of-life-expectancy-across-all-countries-in-1952)
    -   [Density plots of GDP per capita by continent](#density-plots-of-gdp-per-capita-by-continent)
        -   [In the year 1952](#in-the-year-1952)
        -   [In the year 2007](#in-the-year-2007)
    -   [Density plots of life expectancy by continent](#density-plots-of-life-expectancy-by-continent)
        -   [In the year 1952](#in-the-year-1952)
        -   [In the year 2007](#in-the-year-2007)
    -   [Correlation between GDP per capita and life expectancy](#correlation-between-gdp-per-capita-and-life-expectancy)
        -   [In Canada](#in-canada)
        -   [Overall](#overall)
    -   [Continental representation of GDP per capita Vs life expectancy](#continental-representation-of-gdp-per-capita-vs-life-expectancy)
    -   [Continental representation of GDP per capita Vs life expectancy in 1952 and 2007](#continental-representation-of-gdp-per-capita-vs-life-expectancy)
    -   [Sanity check of GDP per capita Vs life expectancy of all continents](#sanity-check-of-gdp-per-capita-vs-life-expectancy-of-all-continents)
    -   [Sanity check comparing GDP per capita across all continents](#sanity-check-comparing-gdp-per-capita-across-all-continents)
    -   [Sanity check comparing life expectancy across all continents](#sanity-check-comparing-life-expectancy-across-all-continents)
